...
class bpdController extends Controller
{
    ...
    {
        $perangkat = perangkat::where('is_bpd', 1)->get();
        return view('pages.dashboard.bpd.index', compact('perangkat'));
    }
    ...
    {
        return view('pages.dashboard.bpd.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.dashboard.bpd.edit', compact('perangkat'));
    }
