<header class="body-font absolute z-10 w-full flex-col items-center text-white bg-navy-1">
            ...
            <a>
                ...
                <div id="dropdownNavbar" class="hidden z-10 w-4 rounded divide-y divide-gray-100 shadow">
                    <ul class="py-1 text-sm text-navy-2 bg-transparent" aria-labelledby="dropdownNavbarButton">
                        ...
                        <a href="#" class="block py-2 px-4 dark:hover:text-white bg-transparent">Geografis</a>
                    </ul>
                </div>
            </a>
