        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Agama</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Tambah Agama</a>
                </li>
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <label for="title"
                                                class="block mb-3 font-medium text-gray-700 text-md">Agama</label>

                                            <input placeholder="Tambah Data Agama" type="text" name="title[]"
    ...
    <script type="text/javascript">
        $("#addServicesRow").click(function() {
            ...
            html += '<div class="col-span-6">\
                                                                                                    <input placeholder="Add Agama" type="text" name="title[]" id="title" autocomplete="title" class="block w-full py-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('title') }}" required>\
                                                                                                    </div>'
