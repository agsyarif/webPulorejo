...
@section('title', 'Tambah Data Perangkat Desa')
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Data Perangakat Desa</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Tambah Data Perangkat Desa</a>
                </li>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        {{-- <input placeholder="Jabatan" type="text" name="jabatan" id="jabatan"
                                            ...
                                            @if ($errors->has('jabatan'))
                                                <p class="text-red-500 mb-3 text-sm">{{ $errors->first('jabatan') }}</p>
                                            @endif --}}
                                        {{--
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="flex items-center mb-4">
                                                    <input id="pangkat1" type="radio" value=0 name="pangkat"
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                    <label for="pangkat1"
                                                ...
                                                <div class="flex items-center">
                                                    <input id="pangkat2" type="radio" value=1 name="pangkat"
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                    <label for="pangkat2"
