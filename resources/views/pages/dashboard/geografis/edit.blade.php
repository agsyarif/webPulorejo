    ...
    <main class="h-full overflow-y-auto bg-gray-200">
            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-12">
                    ...
                    <p class="text-sm text-gray-400">
                        Letak wilayah geografis desa Pulorejo
                    </p>
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Edit letak geografis</a>
                </li>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <input placeholder="Judul Artikel" type="text" name="title" id="title"
                                                ...
                                                value="{{ $geografis->title }}" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea name="isi" id="isi" cols="10" rows="5" hidden>{{ $geografis->description }}</textarea>
                                        ...
                                        <div class="col-span-6 sm:col-span-3 in-wrapper">
                                            ...
                                            <div class="wrapper">
                                                <div class="image">
                                                    <img src="{{ asset('storage/peta/' . $geografis->peta) }}"
                                                        id="preview" alt="">
                                                </div>
                                                <div class="content">
                                                    <div class="icon">
