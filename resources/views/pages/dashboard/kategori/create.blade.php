        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Kategori</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Tambah Kategori</a>
                </li>
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        ...
                        <form action="{{ route('categori-blog.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <label for="title"
                                                class="block mb-3 font-medium text-gray-700 text-md">Kategori</label>

                                            <input placeholder="Tambah Kategori" type="text" name="title[]"
                                                id="title" autocomplete="title"
                                                class="block w-full py-3 mt-4 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
    ...
    <script type="text/javascript">
        $("#addServicesRow").click(function() {
            ...
            html += '<div class="col-span-6">\
                                                            <input placeholder="Tambah Kategori" type="text" name="title[]" id="title" autocomplete="title" class="block w-full py-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('title') }}" required>\
                                                            </div>'
