            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-8">
                    ...
                    <p class="text-sm text-gray-400">
                        {{ $categories->count() }} Total Kategori
                    </p>
                </div>
                        ...
                        <table class="w-full mt-4" aria-label="Table">
                            ...
                            <thead>
                                <tr class="text-sm font-normal text-left text-gray-900 border-b border-b-gray-600">
                                    ...
                                    <th class="py-4" scope="">Deskripsi</th>
                                ...
                                @else
                                    @foreach ($categories as $item)
                                        <tr>
                                            ...
                                            <td class="py-4 flex">
                                                <a href="{{ route('categori-blog.show', $item->id) }}"
                                                    class="pr-2 py-2 mt-2 text-serv-yellow hover:text-gray-800">
                                                    <i class="fa-regular fa-eye"></i>
                                                </a>
                                                <a href="{{ route('categori-blog.edit', $item->id) }}"
                                                    class="pr-2 py-2 mt-2 text-serv-yellow hover:text-gray-800">
                                                    <i class="fa-regular fa-edit"></i>
                                                </a>
                                                <form action="{{ route('categori-blog.destroy', $item->id) }}"
                                                    method="post">
                                                    @method('delete')
                                                    @csrf
