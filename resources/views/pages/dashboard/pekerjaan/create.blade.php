        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Pekerjaan</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Tambah Pekerjaan</a>
                </li>
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <label for="title"
                                                class="block mb-3 font-medium text-gray-700 text-md">Pekerjaan</label>

                                            <input placeholder="Add Pekerjaan" type="text" name="title[]" id="title"
                                                autocomplete="title"
    ...
    <script type="text/javascript">
        $("#addServicesRow").click(function() {
            ...
            html += '<div class="col-span-6">\
                                                                    <input placeholder="Add Pekerjaan" type="text" name="title[]" id="title" autocomplete="title" class="block w-full py-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('title') }}" required>\
                                                                    </div>'
