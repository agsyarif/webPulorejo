            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-8">
                    ...
                    <p class="text-sm text-gray-400">
                        {{ count($perangkat) }} Total Perangkat Desa
                    </p>
                </div>
                    ...
                    <div class="p-6 mt-8 bg-white rounded-xl">
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-400">
                                    {{ count($perangkat) }} Perangkat Desa
                                </p>
                            </div>

                            {{-- <div class="flex relative mt-0 md:mt-6">
                                <a href="{{ route('exportPenduduk') }}"
                                    class="inline-block px-4 py-2 mt-2 text-left text-white rounded-xl bg-navy-1">
                                    Export
                                </a>
                                <button class="inline-block px-4 py-2 mt-2 text-left text-white rounded-xl bg-navy-1"
                                ...
                                @else
                                    @foreach ($perangkat as $item)
                                        <tr>
                                            ...
                                            <td class="py-4 flex">
                                                <a href="{{ route('perangkat.show', $item->id) }}"
