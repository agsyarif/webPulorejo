    ...
    <main class="h-full overflow-y-auto bg-gray-200">
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Edit Artikel</a>
                </li>
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3 in-wrapper">
                                            <div class="wrapper @if ($user->profile_photo_path != null) active @endif">
                                                <div class="image">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <div class="sm:col-span-3">
                                                <input placeholder="User Role" type="text" name="role" id="role"
                                                    autocomplete="role"
                                                    class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                    value="{{ $user->user_role->role }}" required>
                                            ...
                                            <div class="sm:col-span-3">
                                                <input placeholder="User Role" type="text" name="email" id="email"
                                                    autocomplete="email"
                                                    class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
