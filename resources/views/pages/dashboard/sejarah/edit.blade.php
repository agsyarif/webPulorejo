        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Sejarah Desa</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Edit Sejarah</a>
                </li>
                        ...
                        <form action="{{ route('sejarah.update', [$sejarah->id]) }}" method="POST"
                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea name="isi" id="isi" cols="10" rows="5" hidden>{{ $sejarah->sejarah }}</textarea>

                                            <label for="description"
                                                class="block mb-3 font-medium text-gray-700 text-md">Sejarah</label>

                                            <textarea placeholder="Sejarah desa Pulorejo" type="text" name="sejarah" id="sejarah" autocomplete="sejarah"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                rows="4" value="{{ $sejarah->sejarah }}"></textarea>

                                            @if ($errors->has('sejarah'))
                                                <p class="text-red-500 mb-3 text-sm">{{ $errors->first('sejarah') }}
                                                </p>
                                            @endif
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    ...
                                    <a href="{{ route('sejarah.index') }}" type="button"
