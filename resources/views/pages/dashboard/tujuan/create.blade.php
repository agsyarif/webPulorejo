...
@section('title', 'Tambah Tujuan Penduduk')
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Tujuan Desa</a>
                ...
                <li class="flex items-center">
                    <a href="#" class="font-medium">Edit Tujuan Desa</a>
                </li>
                        ...
                        <form action="{{ route('tujuan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <label for="description"
                                                class="block mb-3 font-medium text-gray-700 text-md">Misi Desa</label>

                                            <div class="flex space-x-2">
                                                <select id="misi" name="misi_id" autocomplete="misi"
                                                    ...
                                                    @foreach ($misi as $ctg)
                                                        @if (old('category_id') == $ctg->id)
                                                            <option value={{ $ctg->id }} selected>{{ $ctg->misi }}
                                                            </option>
                                                        @else
                                                            <option value={{ $ctg->id }}>{{ $ctg->misi }}</option>
                                                        @endif
                                                    @endforeach
                                    ...
                                    <div class="mt-4 grid grid-cols-6 gap-6" id="addMisi">
